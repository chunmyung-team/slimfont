  ...
  return (
    <div className="flex flex-col md:flex-row gap-2 md:gap-4 justify-center">
      ...
      <button
        ...
        disabled={isDisabled || isProcessing}
        className="w-full md:w-auto px-6 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors font-medium"
      >
